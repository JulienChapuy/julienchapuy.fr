                                ...
                                <div className="col-md-4">
                                    <div className={styles['about-profile']}>
                                        <div className={styles['about-img']}>
                                            <img src="/assets/img/photo.jpg" className="img-fluid rounded-circle" alt="Profile" />
                                        </div>
                                ...
                                <div className="col-md-8">
                                    <div className={styles['about-me']}>
                                        ...
                                        {content.aboutMe.map((paragraph, index) => (
                                            <p key={index} className={styles['bio-text']} dangerouslySetInnerHTML={{ __html: paragraph }} />
                                        ))}
                                    </div>
                                </div>
                            </div>
