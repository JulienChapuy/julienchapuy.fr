...
const Blog: React.FC<BlogProps> = ({ content, isDedicatedPage = false, limit, lang = 'fr' }) => {
    ...
    return (
        <section id="blog" className={`blog-mf sect-pt4 route ${isDedicatedPage ? 'pt-5' : ''}`}>
            <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        <div className={`title-box text-center ${isDedicatedPage ? 'mb-5' : ''}`}>
                            <h3 className="title-a" style={{ fontWeight: 800, letterSpacing: '-0.02em' }}>
                                {content.title}
                            </h3>
                ...
                <div className="row" style={{ marginTop: isDedicatedPage ? '0' : '4rem' }}>
                ...
                {limit && content.items.length > limit && (
                    <div className="text-center" style={{ marginTop: '3rem' }}>
                        <a href={seeMoreLink} className="btn btn-primary btn-lg" style={{
