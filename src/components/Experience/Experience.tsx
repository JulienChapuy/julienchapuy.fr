...
const Experience: React.FC<ExperienceProps> = ({ title, jobs, limit, seeMoreLink, seeMoreLabel }) => {
                ...
                <div className={styles['tabs-list']} role="tablist">
                    {displayedJobs.map((job, index) => (
                        ...
                        >
                            <div className={styles['tab-label-wrapper']}>
                                ...
                                <span className={`${styles['active-dot']} ${index === 0 ? styles['is-active'] : ''}`} />
                            </div>
                        </button>
                    ))}
                    {seeMoreLink && seeMoreLabel && (
                        <div style={{ marginTop: '1rem', padding: '0 0.5rem' }}>
                            ...
                            >
                                {seeMoreLabel} <i className="fa fa-arrow-right" style={{ marginLeft: '0.5rem' }}></i>
                            </a>
                        </div>
                    )}
                </div>
                    ...
                    <AnimatePresence mode='wait'>
                        ...
                        >
                            <div className={styles['company-header']}>
                                <h3>
                                    <a href={displayedJobs[activeTab].url} target="_blank" rel="noopener noreferrer" className={styles['company-link']}>
