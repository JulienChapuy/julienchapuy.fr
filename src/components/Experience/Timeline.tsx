...
export const TimelineItem: React.FC<TimelineItemProps> = ({ title, period, description, stack, isActive, isLast }) => {
    return (
        <li className={`${styles['timeline-item']} ${isLast ? styles['is-last'] : ''} ${isActive ? styles['is-active'] : ''}`}>
